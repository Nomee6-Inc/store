                ...
                <div class="card">
                  <div class="table-responsive">
                    <table class="table table-vcenter table-mobile-md card-table">
                      ...
                      <tbody>
                        <?php
                        $sql = "SELECT * FROM products WHERE seller = '$getsellertoken';";
                        ...
                        while($row = mysqli_fetch_array($result)){
                            ...
                            <td>
                              <div class=\"font-weight-medium\">₺$productprice</div>
                            </td>
                            <td>
                              <div class=\"btn-list flex-nowrap\">
                              <a href=\"../view_product.php?id=$productid\" class=\"btn\">
                                  Ürünü Göster
                                </a>
                                <a href=\"edit_product.php?id=$productid\" class=\"btn\">
                                  Ürünü Düzenle
                                </a>
                              </div>
                            </td>
